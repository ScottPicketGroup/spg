...
export const Header3 = styled.h3`
  ...
  line-height: ${props => (props.theme.name === "Desktop" ? "1.2" : "1.25")};
  margin-bottom: ${props => (props.marginBottom ? props.marginBottom : 0)};
...
export const BC2 = styled.p`
  font-size: ${props =>
    props.theme.name === "Desktop" ? "1.06rem" : "1rem !important"};
  font-family: ${props => props.theme.fontFamily.UntitledSansLight};
...
export const BC3 = styled.p`
  ...
  font-family: ${props =>
    props.light
      ...
      : props.theme.fontFamily.UntitledSansRegular};
  line-height: 1.22;
  color: ${props => props.theme.colors.text};
  cursor: ${props => (props.link ? "pointer" : "text")};
...
export const ImageCaption = styled.p`
  /* display: inline; */
  font-size: ${props => (props.theme.name === "Desktop" ? "1rem" : "12px")};
  line-height: ${props =>
