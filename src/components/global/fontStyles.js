...
export const Header1 = styled.h1`
  ...
  line-height: ${(props) =>
    props.theme.name === "Desktop" ? "0.94rem" : "1rem"};
...
export const Header3 = styled.h3`
  font-size: ${(props) => (props.theme.name === "Desktop" ? "20px" : "16px")};
  line-height: ${(props) =>
    props.theme.name === "Desktop" ? "1.2rem" : "1.25rem"};
...
export const BC1 = styled.p`
  ...
  font-family: ${(props) => props.theme.fontFamily.UntitledSansLight};
  line-height: ${(props) =>
    props.theme.name === "Desktop" ? "1.22rem" : "1.2rem"};
  color: ${(props) => props.theme.colors.text};
...
export const BC2 = styled.p`
  ...
  font-family: ${(props) => props.theme.fontFamily.UntitledSansLight};
  line-height: ${(props) =>
    props.theme.name === "Desktop" ? "1.17rem" : "1.25rem"};
  color: ${(props) => props.theme.colors.text};
  cursor: ${(props) => (props.link ? "pointer" : "text")};
  &:hover {
    color: ${(props) =>
