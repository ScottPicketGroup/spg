...
const Landing = ({ pageProps }) => {
  ...
  return theme ? (
    <div>
      <Container theme={theme} style={{paddingBottom: `5.75rem`}}>
        ...
        <SectionContainer>
          <InnerContainer>
            ...
            <RightContainer>
              <Header1 theme={theme} style={{marginBottom: `2rem`}}>Scott Pickett Group</Header1>
              <BC1 theme={theme}>
        ...
        <SectionContainer>
          <InnerContainer style={{marginTop: `2.5rem`}}>
            <LeftContainer></LeftContainer>
            <RightContainer>
              <Grid cols={2}>
                <Item link={true}>
        ...
        <SectionContainer>
          <InnerContainer style={{marginTop: `5.75rem`}}>
            <LeftContainer></LeftContainer>
            <RightContainer>
              ...
              <BC1 link={true} theme={theme} style={{marginTop: `2rem`}}>
                Learn More
              </BC1>
            </RightContainer>
          </InnerContainer>
