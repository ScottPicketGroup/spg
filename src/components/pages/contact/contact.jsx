...
const Landing = ({ pageProps }) => {
  ...
  {
    allFile(filter: {extension: {}, absolutePath: {}, name: {in: "contact-hero"}}) {
      edges {
        node {
          id
          childImageSharp {
          ...
          <InnerContainer marginTop="3.5rem">
            ...
            <RightContainer>
              ...
              Please fill out the form below for all Scott Pickett Group enquiries, we’d love to hear from you. 
                ...
                If your enquiry relates to a specific Scott Pickett Group venue, please see the website for details. 
                </BC1>
