...
import LogoSliderNew from "./LogoFooter/LogoSlider"
          ...
          <Grid cols={theme.name === "Desktop" ? 4 : 1} theme={theme}>
            ...
            <Item theme={theme}>
              ...
              <Menu theme={theme}>
                ...
                <MenuItem theme={theme}>
                  <a
                    href="http://www.instagram.com/scottpickettchef"
                    target="_blank"
                ...
                <MenuItem theme={theme}>
                  <a
                    href="https://www.linkedin.com/company/scottpickettgroup/about/"
                    target="_blank"
                    style={{ textDecoration: `none`, color: `white` }}
                  >
                    LinkedIn{" "}
